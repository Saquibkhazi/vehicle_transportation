    ...
    <body>
      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2 style="font-family:Times New Roman;">TYRE</h2>
            </div>
          </div>
          <div class="span8">
            <ul class="breadcrumb">
       ...
       <div style="margin-left: 40px;margin-top: 55px;margin-right: 700px;">
            ...
            <thead>
                <tr>
                    <th> <a href="/tyreadd" style="font-size:133%;" >Tyre Add</a></th><br>
                    <th> <a href="/tyreview" style="font-size:133%;">Tyre View</th><br>
