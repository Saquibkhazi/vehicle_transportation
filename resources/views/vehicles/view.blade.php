      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2 style="font-family:Times New Roman;">List Of Vehicles</h2>
        ...
        <br>
         ...
         <div style="margin-left: 40px;margin-top: 55px;margin-right: 700px;">
           ...
           @foreach($views as $vehicle)
               <tr>
                    <th>{{$vehicle['id']}}</th>
                    <th>{{$vehicle['rtonumber']}}</th>
                    <th>{{$vehicle['type']}}</th>
                    <th>{{$vehicle['model']}}</th>
                    <th>{{$vehicle['fueltype']}}</th>
                    
                    <th><a href={{"vehicledelete/" .$vehicle[ 'id' ]}}>Delete</a></th>
                    <th><a href={{"vehicleupdate/" .$vehicle[ 'id' ]}}>Update</a></th>
               </tr>
            @endforeach
            </thead>
</table>
