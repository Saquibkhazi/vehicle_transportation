        ...
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2 style="font-family:Times New Roman;">List Of Trips </h2>
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">List of Trips</li>
            </ul>
          </div>
        </div>
      </div>
         ...
         <div style="margin-left: 40px;margin-top: 55px;margin-right: 700px;">
           ...
           @foreach($trviews as $trip)
               <tr>
                    ...
                    <th>{{$trip['distance']}}</th>
                    <th>{{$trip['tareweight']}}</th>
                    <th>{{$trip['netweight']}}</th>
                    <th>{{$trip['grossweight']}}</th>
                    <th>{{$trip['driver_id']}}</th>
                    <th>{{$trip['vehicle_id']}}</th>
                    <th><a href={{"tripdelete/" .$trip[ 'id' ]}}>Delete</a></th>
                    <th><a href={{"tripupdate/" .$trip[ 'id' ]}}>Update</a></th>
               </tr>
            @endforeach
            </thead>
</table>
