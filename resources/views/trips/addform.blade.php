       ...
       <div class="row">
         <div class="span4">
           <div class="inner-heading">
             <h2 style="font-family:Times New Roman;">Add Trip Info</h2>
           </div>
         </div>
         <div class="span8">
           <ul class="breadcrumb">
             <li><a href="/home"><i class="icon-home"></i></a><i class="icon-angle-right"></i></li>
             <li><a href="/triphome">Trip</a><i class="icon-angle-right"></i></li>
             <li class="active">Add Trip Info</li>
           </ul>
         </div>
       </div>
     </div>
...
<form  action="tripadd"  method="POST">
          @csrf
            <table>
                ...
                <tr>
                    <td>Date</td>
                    <td><input type="date"  name="date" placeholder="Date" value="" required/></td>
                </tr>
                <tr>
                    <td>Source</td>
                    <td><input type="text"  name="source" placeholder="Source" value="" required/></td>
                </tr>
                <tr>
                    <td>Destination</td>
                    <td><input type="text" name="destination"  placeholder="Destination" value="" required/></td>
                </tr>
                <tr>
                    <td>Distance</td>
                    <td><input type="number" min="1" name="distance"  placeholder="Distance" value="" required/></td>
                </tr>
                <tr>
                    <td>Tareweight</td>
                    <td><input type="number" min="1" name="tareweight"  placeholder="Tareweight" value="" required/></td>
                </tr>
                <tr>
                    <td>Netweight</td>
                    <td><input type="number" min="1" name="netweight"  placeholder="Netweight" value="" required/></td>
                </tr>
                <tr>
                    <td>Grossweight</td>
                    <td><input type="number" min="1" name="grossweight"  placeholder="Grossweight" value="" required/></td>
                </tr>
                <tr>
                    <td>Driver_id </td>
                    <td><input type="number"  min="1" name="driver_id"  placeholder="Driver_id" value="" required/></td>
                </tr>
                <tr>
                    <td>Vehicle_id </td>
