  ...
  <link rel="shortcut icon" href="flat/ico/favicon.png" />
    ...
    <body>
     ...
     <div class="container">
       <div class="row">
         <div class="span4">
           <div class="inner-heading">
             <h2 style="font-family:Times New Roman;">Add Fuel Info</h2>
           </div>
         </div>
         <div class="span8">
           <ul class="breadcrumb">
             <li><a href="/home"><i class="icon-home"></i></a><i class="icon-angle-right"></i></li>
             <li><a href="/fuelhome">Fuel</a><i class="icon-angle-right"></i></li>
             <li class="active">Add Fuel Info</li>
           </ul>
         </div>
       </div>
     </div>
      ...
      <br>
      <form  action="fueladd"  method="POST">
          @csrf
            <table>
            
                <tr>
                    <td>Filled_At</td>
                    <td><input type="datetime-local"  name="filled_at" placeholder="Filled_At" value=""/></td>
                </tr>
                <tr>
                    <td>Quantity</td>
                    <td><input type="number" min="1" name="quantity" placeholder="Quantity" value=""/></td>
                </tr>
                <tr>
                    <td>Amount</td>
                    <td><input type="number" min="1" name="amount"  placeholder="Amount" value=""/></td>
                </tr>
                <tr>
                    <td>Vehicle_Id</td>
                    <td><input type="number" min="1" name="vehicle_id"  placeholder="Vehicle_Id" value=""/></td>
                </tr>
