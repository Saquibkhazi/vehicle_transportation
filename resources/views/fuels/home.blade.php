    ...
    <body>
      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2 style="font-family:Times New Roman;">FUEL</h2>
            </div>
          </div>
          <div class="span8">
            <ul class="breadcrumb">
       ...
       <div style="margin-left: 40px;margin-top: 55px;margin-right: 700px;">
            ...
            <thead>
                <tr>
                    <th> <a href="/fueladd" style="font-size:133%;" >Fuel Add</a></th><br>
                    <th> <a href="/fuelview" style="font-size:133%;">Fuel View</th><br>
