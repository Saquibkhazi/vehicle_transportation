      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2 style="font-family:Times New Roman;">List Of Fuels </h2>
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">List of Fuels</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <br>
         ...
         <div style="margin-left: 40px;margin-top: 55px;margin-right: 700px;">
           ...
           @foreach($fviews as $fuel)
               <tr>
                    <th>{{$fuel['id']}}</th>
                    <th>{{$fuel['filled_at']}}</th>
                    <th>{{$fuel['quantity']}}</th>
                    <th>{{$fuel['amount']}}</th>
                    <th>{{$fuel['vehicle_id']}}</th>
                    
                    <th><a href={{"fueldelete/" .$fuel[ 'id' ]}}>Delete</a></th>
                    <th><a href={{"fuelupdate/" .$fuel[ 'id' ]}}>Update</a></th>
               </tr>
            @endforeach
            </thead>
</table>
