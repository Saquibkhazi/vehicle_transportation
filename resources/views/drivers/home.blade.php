    ...
    <body>
      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2 style="font-family:Times New Roman;">DRIVER</h2>
            </div>
          </div>
          <div class="span8">
            <ul class="breadcrumb">
       ...
       <div style="margin-left: 40px;margin-top: 55px;margin-right: 700px;">
            ...
            <thead>
                <tr>
                    <th> <a href="/driveradd" style="font-size:133%;"  >Driver Add</a></th><br>
                    <th> <a href="/driverview" style="font-size:133%;"> Driver View</th><br>
